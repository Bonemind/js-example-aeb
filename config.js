System.config({
  ...
  map: {
    ...
    "aurelia-swagger-client": "github:paulvanbladel/aurelia-swagger-client@0.1.12",
    ...
    "github:paulvanbladel/aurelia-swagger-client@0.1.12": {
    ...
    "npm:swagger-client-generator@0.2.13": {
      "process": "github:jspm/nodelibs-process@0.1.2",
      "swagger-validate": "npm:swagger-validate@0.1.7",
      "systemjs-json": "github:systemjs/plugin-json@0.1.0"
    },
    "npm:swagger-client@2.1.6": {
      "btoa": "npm:btoa@1.1.2",
      "buffer": "github:jspm/nodelibs-buffer@0.1.0",
      "cookiejar": "npm:cookiejar@2.0.1",
